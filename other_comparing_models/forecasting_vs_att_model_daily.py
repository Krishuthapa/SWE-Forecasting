...
output_1 = '{}/outputs/forecasting_vs_att_tr_act_loss.txt'.format(baseUrl)
output_2 = '{}/outputs/forecasting_vs_att_ts_act_loss.txt'.format(baseUrl)
...
class SweAttetnionTemporal(nn.Module):
    def __init__(self, input_dim, sp_dim, prompt_dim, model_dim, output_dim, num_layers, nhead):
        ...
        self.daily_obs_embed_1 = nn.Linear(input_dim * 120, int(model_dim/2))
    ...
    def forward(self, x_daily, x_yearly, prompts):
        ...
        final_encoded_info = torch.cat((daily_obs_encoding, yearly_obs_encoding), dim = -1)
...
hasFile = os.path.isfile("{}/checkpoints/forecasting_daily_vanilla_att_sp_model.pt".format(baseUrl))
...
with open(output_1, 'w') as file1:
    with redirect_stdout(file1):
        ...
        if hasFile:
            checkpoint = torch.load("{}/checkpoints/forecasting_daily_vanilla_att_sp_model.pt".format(baseUrl))
        ...
        while strike_count <= 3 and epoch_number <= 10:
            ...
            if epoch_loss_sp < best_nse:
                ...
                }, "{}/checkpoints/forecasting_daily_vanilla_att_sp_model.pt".format(baseUrl))
...
joblib.dump(daily_window_predicted_1, '{}/results/predict/2014_daily_window_predict_vs_att.pkl'.format(baseUrl))
joblib.dump(daily_window_predicted_2, '{}/results/predict/2015_daily_window_predict_vs_att.pkl'.format(baseUrl))
joblib.dump(daily_window_predicted_3, '{}/results/predict/2016_daily_window_predict_vs_att.pkl'.format(baseUrl))
joblib.dump(daily_window_predicted_4, '{}/results/predict/2017_daily_window_predict_vs_att.pkl'.format(baseUrl))
joblib.dump(daily_window_predicted_5, '{}/results/predict/2018_daily_window_predict_vs_att.pkl'.format(baseUrl))

joblib.dump(daily_window_actual_1, '{}/results/actual/2014_daily_window_actual_vs_att.pkl'.format(baseUrl))
joblib.dump(daily_window_actual_2, '{}/results/actual/2015_daily_window_actual_vs_att.pkl'.format(baseUrl))
joblib.dump(daily_window_actual_3, '{}/results/actual/2016_daily_window_actual_vs_att.pkl'.format(baseUrl))
joblib.dump(daily_window_actual_4, '{}/results/actual/2017_daily_window_actual_vs_att.pkl'.format(baseUrl))
joblib.dump(daily_window_actual_5, '{}/results/actual/2018_daily_window_actual_vs_att.pkl'.format(baseUrl))

joblib.dump(daily_predicted_1, '{}/results/predict/2014_daily_predict_vs_att.pkl'.format(baseUrl))
joblib.dump(daily_predicted_2, '{}/results/predict/2015_daily_predict_vs_att.pkl'.format(baseUrl))
joblib.dump(daily_predicted_3, '{}/results/predict/2016_daily_predict_vs_att.pkl'.format(baseUrl))
joblib.dump(daily_predicted_4, '{}/results/predict/2017_daily_predict_vs_att.pkl'.format(baseUrl))
joblib.dump(daily_predicted_5, '{}/results/predict/2018_daily_predict_vs_att.pkl'.format(baseUrl))

joblib.dump(daily_actual_1, '{}/results/actual/2014_daily_actual_vs_att.pkl'.format(baseUrl))
joblib.dump(daily_actual_2, '{}/results/actual/2015_daily_actual_vs_att.pkl'.format(baseUrl))
joblib.dump(daily_actual_3, '{}/results/actual/2016_daily_actual_vs_att.pkl'.format(baseUrl))
joblib.dump(daily_actual_4, '{}/results/actual/2017_daily_actual_vs_att.pkl'.format(baseUrl))
joblib.dump(daily_actual_5, '{}/results/actual/2018_daily_actual_vs_att.pkl'.format(baseUrl))
