...
output_1 = '{}/outputs/forecasting_lstm_tr_act_loss.txt'.format(baseUrl)
output_2 = '{}/outputs/forecasting_lstm_ts_act_loss.txt'.format(baseUrl)
...
class SweLSTM(nn.Module):
    def __init__(self, input_dim, sp_dim, prompt_dim, hidden_dim, output_dim, num_layers, forecasting_length):
        ...
        self.decoder = DecoderLSTM(output_dim, 2 * hidden_dim, num_layers)
    ...
    def forward(self, x_daily, x_yearly, prompts):
        ...
        hidden_yearly, cell_yearly = self.encoder_yearly(source_daily)
        ...
        cell = torch.cat((cell_daily,cell_yearly), dim = -1)
        hidden = torch.cat((hidden_yearly,hidden_daily), dim = -1)
...
hasFile = os.path.isfile("{}/checkpoints/forecasting_daily_lstm_model.pt".format(baseUrl))
...
with open(output_1, 'w') as file1:
    with redirect_stdout(file1):
        ...
        if hasFile:
            checkpoint = torch.load("{}/checkpoints/forecasting_daily_lstm_model.pt".format(baseUrl))
        ...
        while strike_count <= 3 and epoch_number <= 10:
            ...
            if epoch_loss_sp < best_nse:
                ...
                }, "{}/checkpoints/forecasting_daily_lstm_model.pt".format(baseUrl))
...
joblib.dump(daily_window_predicted_1, '{}/results/predict/2014_daily_window_predict_lstm.pkl'.format(baseUrl))
joblib.dump(daily_window_predicted_2, '{}/results/predict/2015_daily_window_predict_lstm.pkl'.format(baseUrl))
joblib.dump(daily_window_predicted_3, '{}/results/predict/2016_daily_window_predict_lstm.pkl'.format(baseUrl))
joblib.dump(daily_window_predicted_4, '{}/results/predict/2017_daily_window_predict_lstm.pkl'.format(baseUrl))
joblib.dump(daily_window_predicted_5, '{}/results/predict/2018_daily_window_predict_lstm.pkl'.format(baseUrl))

joblib.dump(daily_window_actual_1, '{}/results/actual/2014_daily_window_actual_lstm.pkl'.format(baseUrl))
joblib.dump(daily_window_actual_2, '{}/results/actual/2015_daily_window_actual_lstm.pkl'.format(baseUrl))
joblib.dump(daily_window_actual_3, '{}/results/actual/2016_daily_window_actual_lstm.pkl'.format(baseUrl))
joblib.dump(daily_window_actual_4, '{}/results/actual/2017_daily_window_actual_lstm.pkl'.format(baseUrl))
joblib.dump(daily_window_actual_5, '{}/results/actual/2018_daily_window_actual_lstm.pkl'.format(baseUrl))

joblib.dump(daily_predicted_1, '{}/results/predict/2014_daily_predict_lstm.pkl'.format(baseUrl))
joblib.dump(daily_predicted_2, '{}/results/predict/2015_daily_predict_lstm.pkl'.format(baseUrl))
joblib.dump(daily_predicted_3, '{}/results/predict/2016_daily_predict_lstm.pkl'.format(baseUrl))
joblib.dump(daily_predicted_4, '{}/results/predict/2017_daily_predict_lstm.pkl'.format(baseUrl))
joblib.dump(daily_predicted_5, '{}/results/predict/2018_daily_predict_lstm.pkl'.format(baseUrl))

joblib.dump(daily_actual_1, '{}/results/actual/2014_daily_actual_lstm.pkl'.format(baseUrl))
joblib.dump(daily_actual_2, '{}/results/actual/2015_daily_actual_lstm.pkl'.format(baseUrl))
joblib.dump(daily_actual_3, '{}/results/actual/2016_daily_actual_lstm.pkl'.format(baseUrl))
joblib.dump(daily_actual_4, '{}/results/actual/2017_daily_actual_lstm.pkl'.format(baseUrl))
joblib.dump(daily_actual_5, '{}/results/actual/2018_daily_actual_lstm.pkl'.format(baseUrl))
