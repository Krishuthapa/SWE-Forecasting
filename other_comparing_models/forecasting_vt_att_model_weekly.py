...
output_1 = '{}/outputs/forecasting_vt_att_weekly_tr_act_loss.txt'.format(baseUrl)
output_2 = '{}/outputs/forecasting_vt_att_weekly_ts_act_loss.txt'.format(baseUrl)
...
class SweAttetnionTemporal(nn.Module):
    ...
    def forward(self, x_daily, x_weekly, x_yearly, prompts):
        ...
        weekly_obs_embedding = self.observation_embedding_1(source_weekly.reshape(batch_size * weeks_count, -1))
        ...
        weekly_obs_embedding = self.observation_embedding_2(weekly_obs_embedding)
        weekly_obs_embedding = self.positonal_embedding(weekly_obs_embedding.reshape(batch_size, weeks_count, self.model_dim))
        ...
        selected_weekly_obs_encoding = weekly_obs_encoding[:,-1,:].reshape(1, batch_size, self.model_dim)
        selected_weekly_obs_encoding = selected_weekly_obs_encoding + location_embedding
        ...
        final_encoded_info = torch.cat((selected_daily_obs_encoding, selected_weekly_obs_encoding,selected_yearly_obs_encoding), dim = -1)
...
hasFile = os.path.isfile("{}/checkpoints/forecasting_weekly_vanilla_att_temp_model.pt".format(baseUrl))
...
with open(output_1, 'w') as file1:
    with redirect_stdout(file1):
        ...
        if hasFile:
            checkpoint = torch.load("{}/checkpoints/forecasting_weekly_vanilla_att_temp_model.pt".format(baseUrl))
        ...
        while strike_count <= 3 and epoch_number <= 10:
            ...
            if epoch_loss_sp < best_nse:
                ...
                }, "{}/checkpoints/forecasting_weekly_vanilla_att_temp_model.pt".format(baseUrl))
...
joblib.dump(weekly_window_predicted_1, '{}/results/predict/2014_weekly_window_predict_vt_att.pkl'.format(baseUrl))
joblib.dump(weekly_window_predicted_2, '{}/results/predict/2015_weekly_window_predict_vt_att.pkl'.format(baseUrl))
joblib.dump(weekly_window_predicted_3, '{}/results/predict/2016_weekly_window_predict_vt_att.pkl'.format(baseUrl))
joblib.dump(weekly_window_predicted_4, '{}/results/predict/2017_weekly_window_predict_vt_att.pkl'.format(baseUrl))
joblib.dump(weekly_window_predicted_5, '{}/results/predict/2018_weekly_window_predict_vt_att.pkl'.format(baseUrl))

joblib.dump(weekly_window_actual_1, '{}/results/actual/2014_weekly_window_actual_vt_att.pkl'.format(baseUrl))
joblib.dump(weekly_window_actual_2, '{}/results/actual/2015_weekly_window_actual_vt_att.pkl'.format(baseUrl))
joblib.dump(weekly_window_actual_3, '{}/results/actual/2016_weekly_window_actual_vt_att.pkl'.format(baseUrl))
joblib.dump(weekly_window_actual_4, '{}/results/actual/2017_weekly_window_actual_vt_att.pkl'.format(baseUrl))
joblib.dump(weekly_window_actual_5, '{}/results/actual/2018_weekly_window_actual_vt_att.pkl'.format(baseUrl))

joblib.dump(weekly_predicted_1, '{}/results/predict/2014_weekly_predict_vt_att.pkl'.format(baseUrl))
joblib.dump(weekly_predicted_2, '{}/results/predict/2015_weekly_predict_vt_att.pkl'.format(baseUrl))
joblib.dump(weekly_predicted_3, '{}/results/predict/2016_weekly_predict_vt_att.pkl'.format(baseUrl))
joblib.dump(weekly_predicted_4, '{}/results/predict/2017_weekly_predict_vt_att.pkl'.format(baseUrl))
joblib.dump(weekly_predicted_5, '{}/results/predict/2018_weekly_predict_vt_att.pkl'.format(baseUrl))

joblib.dump(weekly_actual_1, '{}/results/actual/2014_weekly_actual_vt_att.pkl'.format(baseUrl))
joblib.dump(weekly_actual_2, '{}/results/actual/2015_weekly_actual_vt_att.pkl'.format(baseUrl))
joblib.dump(weekly_actual_3, '{}/results/actual/2016_weekly_actual_vt_att.pkl'.format(baseUrl))
joblib.dump(weekly_actual_4, '{}/results/actual/2017_weekly_actual_vt_att.pkl'.format(baseUrl))
joblib.dump(weekly_actual_5, '{}/results/actual/2018_weekly_actual_vt_att.pkl'.format(baseUrl))
