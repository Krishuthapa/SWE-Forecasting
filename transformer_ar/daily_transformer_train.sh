...
requirements_file="requirement_files/transformer_requirement.txt"
...
export FORECASTING_WINDOW=10
export FORECASTING_STEP=1
export INPUT_DIM=21
...
python "$base_url/transformer_ar/transformer_daily_train.py"
