...
output_1 = '{}/outputs/forecasting_modified_daily_att_tr_act_loss.txt'.format(baseUrl)
output_2 = '{}/outputs/forecasting_modified_daily_att_ts_act_loss.txt'.format(baseUrl)
...
hasFile = os.path.isfile("{}/checkpoints/forecasting_modified_daily_att_climax_model_gp_act.pt".format(baseUrl))
...
with open(output_1, 'w') as file1:
    with redirect_stdout(file1):
        ...
        if hasFile:
            checkpoint = torch.load("{}/checkpoints/forecasting_modified_daily_att_climax_model_gp_act.pt".format(baseUrl))
        ...
        while strike_count <= 3 and epoch_number <= 8:
            ...
            if epoch_loss_sp < best_nse:
                ...
                }, "{}/checkpoints/forecasting_modified_daily_att_climax_model_gp_act.pt".format(baseUrl))
...
def getFinalInputsForGP(training_yr_indices, train_prompts):
    ...
    torch.save(input_learnt_representations, '{}/outputs/forecasting_modified_daily_att_inputs_for_gp_act.pt'.format(baseUrl))
    torch.save(predicted_outputs, '{}/outputs/forecasting_modified_daily_att_predicted_outputs_for_gp_act.pt'.format(baseUrl))
    torch.save(actual_outputs, '{}/outputs/forecasting_modified_daily_att_outputs_for_gp_act.pt'.format(baseUrl))
...
torch.save(test_1_final_representations, '{}/outputs/daily_test1_inputs_for_gp_act.pt'.format(baseUrl))
torch.save(test_2_final_representations, '{}/outputs/daily_test2_inputs_for_gp_act.pt'.format(baseUrl))
torch.save(test_3_final_representations, '{}/outputs/daily_test3_inputs_for_gp_act.pt'.format(baseUrl))
torch.save(test_4_final_representations, '{}/outputs/daily_test4_inputs_for_gp_act.pt'.format(baseUrl))
torch.save(test_5_final_representations, '{}/outputs/daily_test5_inputs_for_gp_act.pt'.format(baseUrl))
